{% include messages/notice.html
    ...
    the major [update documentation](https://help.passbolt.com/hosting/upgrade) to roll out this new version."
    link="https://help.passbolt.com/hosting/upgrade"
    ask="Read the doc"
%}
...
blog post, but long story short, the goal of this change is to allow storing secrets other than a password. 
The first example of a new resource type is the “password with encrypted description”. This change is transparent 
...
and the encrypted part containing, for example the passwords called “secret”. With resource types the solution will 
...
default resource types, and the format you would like to see, please share your ideas on the 
[community forum](https://community.passbolt.com).

There were some issues with the release of the webextension, which has been summarized on this dedicated 
[incident page](https://www.passbolt.com/incidents). The most prominent bugs encountered in the last release were
related to older installations where some database entries became incompatible with new stricter validation rules on 
the front-end side. These issues have now been resolved, but we apologize for any inconvenience caused.

Server side is also a major release with the deprecation of PHP v7.2 and composer v1. Please make sure you have 
the right dependencies installed on your server prior to upgrade. You can learn more about the upgrade procedure 
on the [dedicated page](https://help.passbolt.com/hosting/upgrade).
...
actively working on the Mobile app!
