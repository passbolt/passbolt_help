...
as well as [RHEL 9](/hosting/install) and [RockyLinux 9](/hosting/install). We also upgraded the front-end to 
...
We would like to thank everyone who participated in the translation on the [Crowdin](https://passbolt.crowdin.com/) platform, the security
team of Cure53, as well Ashley Primo for helping to make passbolt even more accessible and secure for everyone.
