...
{% include articles/figure.html url="/assets/img/help/2024/05/Passbolt-API-Status-in-UI.png" legend="Passbolt API Status" width="780px" %}

As usual this information is also available for administrators via the health check command line. 

{% include articles/figure.html url="/assets/img/help/2024/05/Healthcheck-Directory-Sync-in-CLI.png" legend="Directory Sync" width="780px" %}
