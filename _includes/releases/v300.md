...
are using debian package. Using debian package introduces new changes on the installation paths of passbolt. Please the following 
 ...
 * [Migrate](https://help.passbolt.com/hosting/update/ubuntu-package.html) from ubuntu installation scripts to Ubuntu package.
